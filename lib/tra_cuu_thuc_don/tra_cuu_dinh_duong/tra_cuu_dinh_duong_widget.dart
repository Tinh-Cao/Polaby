        ...
        body: SafeArea(
          ...
          child: Padding(
            ...
            child: Column(
                      ...
                      if ((FFAppState().search != '') ||
                        ...
                        return Container(
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            future: PolabyGroup.ingredientSearchGETCall.call(
                              order: ' aaaaaaaaaaa',
                              ...
                              foodGroup: FFAppState().filterState >= 1
                                  ? (FFAppState().filterState - 1).toString()
                                  : ' ',
                            ),
                              ...
                              return Builder(
                                builder: (context) {
                                  final eachIngredientSearch =
                                      PolabyGroup.ingredientSearchGETCall
                                              .ingredientSearchs(
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemCount: eachIngredientSearch.length,
                                    separatorBuilder: (_, __) =>
                                        const SizedBox(height: 8.0),
                                    itemBuilder:
                                        (context, eachIngredientSearchIndex) {
                          ...
                          child: RefreshIndicator(
                            ...
                            child: PagedListView<ApiPagingParams,
                              ...
                              pagingController: _model.setListViewController2(
                                (nextPageMarker) =>
                                    PolabyGroup.ingredientSearchGETCall.call(
                                  order: ' aaaaaaaaaaa',
                                  orderByDescending: false,
                                  isDeleted: false,
                                  search: FFAppState().search,
                              ...
                              builderDelegate:
                                ...
                                itemBuilder:
                                    (context, _, eachIngredientSearchIndex) {
                                  final eachIngredientSearchItem = _model
                                      .listViewPagingController2!
                                      .itemList![eachIngredientSearchIndex];
                                  return Align(
                                    alignment: const AlignmentDirectional(-1.0, 0.0),
                                    child: InkWell(
                                      splashColor: Colors.transparent,
              ...
              ].divide(const SizedBox(height: 8.0)).addToEnd(const SizedBox(height: 32.0)),
            ),
          ),
        ),
      ),
