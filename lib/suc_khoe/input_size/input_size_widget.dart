...
import 'input_size_model.dart';
export 'input_size_model.dart';

class InputSizeWidget extends StatefulWidget {
  const InputSizeWidget({
    super.key,
    this.size,
    this.id,
  });
  ...
  @override
  State<InputSizeWidget> createState() => _InputSizeWidgetState();
}

class _InputSizeWidgetState extends State<InputSizeWidget> {
  late InputSizeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InputSizeModel());
                      ...
                      if (widget.size == 0.0) {
                        ...
                        if ((_model.apiResultb7y?.succeeded ?? true)) {
                          ...
                          FFAppState().healthSize =
                              PolabyGroup.apiV1HealthsGETCall
                                  .healths(
                                    (_model.healthSizeUpdate?.jsonBody ?? ''),
                                  )!
                                  .toList()
                                  .cast<dynamic>();
                          FFAppState().update(() {});
