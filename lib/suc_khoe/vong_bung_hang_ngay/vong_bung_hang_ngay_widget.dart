...
import '/suc_khoe/input_size/input_size_widget.dart';
import '/suc_khoe/update_size/update_size_widget.dart';
import '/flutter_flow/custom_functions.dart' as functions;
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'vong_bung_hang_ngay_model.dart';
export 'vong_bung_hang_ngay_model.dart';

class VongBungHangNgayWidget extends StatefulWidget {
  const VongBungHangNgayWidget({super.key});

  @override
  State<VongBungHangNgayWidget> createState() => _VongBungHangNgayWidgetState();
}

class _VongBungHangNgayWidgetState extends State<VongBungHangNgayWidget> {
  late VongBungHangNgayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VongBungHangNgayModel());
                                                  ...
                                                  valueOrDefault<String>(
                                                    '${getJsonField(
                                                          ...
                                                          FFAppState()
                                                              ...
                                                              .first,
                                                          r'''$.value''',
                                                        )).toStringAsFixed(1))).toString() : '0'} cm',
                                                    '0 cm',
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                          ...
                                          child: Builder(
                                            builder: (context) {
                                              ...
                                              return ListView.separated(
                                                ...
                                                itemCount: eachSize.length,
                                                separatorBuilder: (_, __) =>
                                                    const SizedBox(height: 16.0),
                                                itemBuilder:
                                                    (context, eachSizeIndex) {
                                                  final eachSizeItem =
                                                      eachSize[eachSizeIndex];
                                                  return InkWell(
                                                    splashColor:
                                                        Colors.transparent,
                                                    focusColor:
                                                              ...
                                                              Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    valueOrDefault<
                                                                        String>(
                                                                      functions.calculateDifference(FFAppState().healthSize.toList(), eachSizeIndex)! >=
                                                                              0.0
                                                                          ? '+${functions.calculateDifference(FFAppState().healthSize.toList(), eachSizeIndex)?.toString()} cm'
                                                                          : '${functions.calculateDifference(FFAppState().healthSize.toList(), eachSizeIndex)?.toString()} cm',
                                                                      '0',
                                                                    ),
                                                                    textAlign:
                                                                    ...
                                                                    style: FlutterFlowTheme.of(
                                                                        ...
                                                                        .override(
                                                                          ...
                                                                          color:
                                                                            ...
                                                                            functions.calculateDifference(FFAppState().healthSize.toList(), eachSizeIndex)! >= 0.0
