...
import 'dang_ky_model.dart';
export 'dang_ky_model.dart';
...
class _DangKyWidgetState extends State<DangKyWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DangKyModel());

    _model.textController1 ??= TextEditingController();
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??= TextEditingController(text: _model.value);
