...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    polabyMobileAuthUserSubject.add(
      PolabyMobileAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<PolabyMobileAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  PolabyMobileAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = PolabyMobileAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    polabyMobileAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
PolabyMobileAuthUser? currentUser;
