...
import 'them_lich_hen_widget.dart' show ThemLichHenWidget;
import 'package:flutter/material.dart';

class ThemLichHenModel extends FlutterFlowModel<ThemLichHenWidget> {
  ///  State fields for stateful widgets in this component.

  // Stores action output result for [Firestore Query - Query a collection] action in them_lich_hen widget.
