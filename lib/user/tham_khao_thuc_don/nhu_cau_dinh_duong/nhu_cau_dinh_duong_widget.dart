              ...
              children: [
                FutureBuilder<ApiCallResponse>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final containerApiV1MenusRecommendationsGETResponse =
                        snapshot.data!;
                                      ...
                                      Text(
                                        valueOrDefault<String>(
                                          PolabyGroup
                                              ...
                                              .kcalRecomment(
                                                containerApiV1MenusRecommendationsGETResponse
                                                    .jsonBody,
                                              )
                                              ?.toString(),
                                          '2000',
                        ...
                        Flexible(
                          child: FutureBuilder<ApiCallResponse>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final listViewApiV1MenusRecommendationsGETResponse =
                                  snapshot.data!;
                              ...
                              return Builder(
                                builder: (context) {
                                  final eachMenu = PolabyGroup
                                          .apiV1MenusRecommendationsGETCall
                                          .menus(
                                            listViewApiV1MenusRecommendationsGETResponse
                                                .jsonBody,
                                          )
                                          ?.toList() ??
                                      [];
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemBuilder: (context, eachMenuIndex) {
                                      ...
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          _model.menuSaved = await PolabyGroup
                                              .menuUserGETCall
                                              .call(
