...
import 'chi_tiet_tai_khoan_expert_model.dart';
export 'chi_tiet_tai_khoan_expert_model.dart';

class ChiTietTaiKhoanExpertWidget extends StatefulWidget {
  const ChiTietTaiKhoanExpertWidget({super.key});

  @override
  State<ChiTietTaiKhoanExpertWidget> createState() =>
      _ChiTietTaiKhoanExpertWidgetState();
}

class _ChiTietTaiKhoanExpertWidgetState
    extends State<ChiTietTaiKhoanExpertWidget> with TickerProviderStateMixin {
  late ChiTietTaiKhoanExpertModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChiTietTaiKhoanExpertModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResults78 = await PolabyGroup.ratingsGETCall.call(
        accountId: currentUserUid,
      );

      if ((_model.apiResults78?.succeeded ?? true)) {
        _model.numberofPeople =
            functions.calculateNumberOfRatings(PolabyGroup.ratingsGETCall
                .stars(
                  (_model.apiResults78?.jsonBody ?? ''),
                )
                ?.toList());
        _model.raitingAverage =
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                Text(
                                  FFAppState().UserInfo.data.level,
                                ...
                                Text(
                                  FFAppState().UserInfo.data.yearsOfExperience,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Inter',
                                ...
                                Text(
                                  FFAppState().UserInfo.data.workplace,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Inter',
                          ...
                          Align(
                            ...
                            child: FlutterFlowButtonTabBar(
                              ...
                              backgroundColor: FlutterFlowTheme.of(context)
                                  .primaryBackground,
                              unselectedBackgroundColor: const Color(0xFFEAEAEB),
                              borderColor:
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: FutureBuilder<ApiCallResponse>(
                                        future: PolabyGroup.ratingsGETCall.call(
                                          accountId: currentUserUid,
                                        ),
                                        builder: (context, snapshot) {
                                          // Customize what your widget looks like when it's loading.
                                          ...
                                          return Builder(
                                            builder: (context) {
                                              final eachRaings =
                                                  PolabyGroup.ratingsGETCall
                                                          .ratings(
                                                            listViewRatingsGETResponse
                                                                .jsonBody,
                                                          )
                                                          ?.toList() ??
                                                      [];
                                              ...
                                              return ListView.builder(
                                                ...
                                                itemCount: eachRaings.length,
                                                itemBuilder:
                                                    (context, eachRaingsIndex) {
                                                  final eachRaingsItem =
                                                      eachRaings[
                                                          eachRaingsIndex];
                                                  return Padding(
                                                    padding:
                                                        ...
                                                        Align(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              RatingsWidget(
                                                                key: Key(
                                                                    'Key3gh_${eachRaingsIndex}_of_${eachRaings.length}'),
                                                                parameter1:
                                                                    getJsonField(
                                                                  eachRaingsItem,
                                                                  r'''$.star''',
